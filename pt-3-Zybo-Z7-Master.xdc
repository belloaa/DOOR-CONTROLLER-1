...
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L24P_T3_34 Sch=sw[1]
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { enable }]; #IO_L4N_T0_34 Sch=sw[2]
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { mode_sel }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { motor[0] }]; #IO_L23P_T3_35 Sch=led[0]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { motor[1] }]; #IO_L23N_T3_35 Sch=led[1]
...
##RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { door_rgb[2] }]; #IO_L18P_T2_34 Sch=led6_r
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { door_rgb[1] }]; #IO_L6N_T0_VREF_35 Sch=led6_g
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { door_rgb[0] }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
...
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports {motion_sensor }]; #IO_L10P_T1_34 Sch=jc_p[1]   		aa	 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports {fully_closed }]; #IO_L10N_T1_34 Sch=jc_n[1]		ab     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports {fully_open}]; #IO_L1P_T0_34 Sch=jc_p[2]         ac     
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { }]; #IO_L1N_T0_34 Sch=jc_n[2]         ad     
...
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { segments[1] }]; #IO_L 5N_T0_34 Sch=jd_n[1]				 
